...
public class ItemFactory
{
	...
	private static Dictionary<string, string[]> BuildItemTags()
	{
		...
		itemTags.Add("minecraft:wooden_stairs", itemTags["minecraft:wooden_slabs"].Select(i => i.Replace("slab", "stairs")).ToArray());
		...
		itemTags.Add("minecraft:flowers", [
			"minecraft:allium", "minecraft:azure_bluet", "minecraft:blue_orchid", "minecraft:cornflower", "minecraft:lily_of_the_valley",
