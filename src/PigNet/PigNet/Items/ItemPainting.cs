...
public partial class ItemPainting
{
	...
	public override bool PlaceBlock(Level world, Player player, BlockCoordinates targetCoordinates, BlockFace face, Vector3 faceCoords)
	{
		...
		BlockCoordinates coordinates = targetCoordinates;
		...
		(PaintingData, BoundingBox) paintingTuple = paintings[new Random().Next(paintings.Count)];
		PaintingData paintingData = paintingTuple.Item1;

		var painting = new Painting(world, paintingData)
		{
			Bbox = paintingTuple.Item2,
	...
	public class PaintingData(string title, int width, int widthOffset, int height, int heightOffset)
	{
		...
		public int WidthOffset { get; } = widthOffset;
		public int Height { get; } = height;
		public int HeightOffset { get; } = heightOffset;
	}
}