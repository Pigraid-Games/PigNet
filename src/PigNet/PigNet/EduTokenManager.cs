	...
	public class EduTokenManager
	{
		...
		public EduTokenManager()
		{
			...
			else
			{
				...
				Log.Fatal($"Plaintext credentials in PigNet configuration files are not allowed. Please use the following encrypted configuration for safe usage of Microsoft Account credentials\n" +
