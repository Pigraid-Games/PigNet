...
public class EntitySpawnManager
{
	...
	public static readonly EntityType[] PassiveMobs = { EntityType.Chicken, EntityType.Cow, EntityType.Pig, EntityType.Sheep, EntityType.Wolf, EntityType.Rabbit, EntityType.Horse };

	public static readonly EntityType[] HostileMobs = { EntityType.Spider, EntityType.Zombie, EntityType.Skeleton, EntityType.Creeper, EntityType.Enderman };
	...
	{
		Tuple<EntityType, int>[] weightedPassiveMobs = { new Tuple<EntityType, int>(EntityType.Sheep, 12), new Tuple<EntityType, int>(EntityType.Chicken, 10), new Tuple<EntityType, int>(EntityType.Pig, 10), new Tuple<EntityType, int>(EntityType.Cow, 8), new Tuple<EntityType, int>(EntityType.Wolf, 5), new Tuple<EntityType, int>(EntityType.Rabbit, 2), new Tuple<EntityType, int>(EntityType.Horse, 1) };

		Tuple<EntityType, int>[] weightedHostileMobs = { new Tuple<EntityType, int>(EntityType.Spider, 100), new Tuple<EntityType, int>(EntityType.Zombie, 100), new Tuple<EntityType, int>(EntityType.Skeleton, 100), new Tuple<EntityType, int>(EntityType.Creeper, 100), new Tuple<EntityType, int>(EntityType.Enderman, 10) };
