...
public class StreamingSicBlockCipher : BufferedCipherBase
{
	...
	private readonly SicStreamCipher parent;
	...
	public override string AlgorithmName => parent.AlgorithmName;
	...
	{
		return new[] { parent.ReturnByte(input) };
	}
...
public class SicStreamCipher : IStreamCipher
{
	...
	private readonly int blockSize;
	private readonly SicBlockCipher parent;

	private readonly byte[] zeroBlock;
	...
	public string AlgorithmName => parent.AlgorithmName;
