...
namespace PigNet.Blocks.States;
	...
	public class OldFacingDirection3 : OldFacingDirection
	{
		...
		public static implicit operator OldFacingDirection3(PigNet.Utils.Direction direction)
		{
		...
		public static implicit operator PigNet.Utils.Direction(OldFacingDirection3 direction)
		{
		...
		public static implicit operator OldFacingDirection3(PigNet.BlockFace face)
		{
			return face switch
			{
		...
		public static implicit operator PigNet.BlockFace(OldFacingDirection3 direction)
		{
			return direction.Value switch
			{
