...
{
	public class ItemActor : Mob
	{
		private static readonly ILog Log = LogManager.GetLogger(typeof(ItemActor));

		public Item Item { get; set; }
		public int PickupDelay { get; set; }
		public int TimeToLive { get; set; }

		public ItemActor(Level level, Item item) : base(EntityType.DroppedItem, level)
		{
			Item = item;
		...
		{
			McpeAddItemActor mcpeAddItemActor = McpeAddItemActor.CreateObject();
			mcpeAddItemActor.entityIdSelf = EntityId;
			mcpeAddItemActor.runtimeActorId = EntityId;
			mcpeAddItemActor.item = GetItemStack();
			mcpeAddItemActor.x = KnownPosition.X;
			mcpeAddItemActor.y = KnownPosition.Y;
			mcpeAddItemActor.z = KnownPosition.Z;
			mcpeAddItemActor.speedX = Velocity.X;
			mcpeAddItemActor.speedY = Velocity.Y;
			mcpeAddItemActor.speedZ = Velocity.Z;
			mcpeAddItemActor.metadata = GetMetadata();
			LastSentPosition = (PlayerLocation) KnownPosition.Clone();
			Level.RelayBroadcast(players, mcpeAddItemActor);
