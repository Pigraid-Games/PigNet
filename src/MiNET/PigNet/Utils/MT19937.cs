...
public class MT19937
{
	...
	private static readonly ulong[ /* 2 */] mag01 = { 0x0, MATRIX_A };
	...
	public void Seed(ulong seed)
	{
		...
		mt[0] = seed;
		for (mti = 1; mti < N; mti++) mt[mti] = (6364136223846793005 * (mt[mti - 1] ^ (mt[mti - 1] >> 62))) + mti;
	}
	...
	public ulong UInt64()
	{
		...
		if (mti >= N) /* generate N words at one time */
		{
			...
			if (mti == N + 1) /* if sgenrand() has not been called, */ Seed(5489); /* a default initial seed is used   */
	...
	public long Int63()
	{
		return (long) (UInt64() >> 1);
	}

	/* generates a random number on [0,1]-real-interval */
	public double Real1()
	{
		return (UInt64() >> 11) * (1.0 / 9007199254740991.0);
	}

	/* generates a random number on [0,1)-real-interval */
	public double Real2()
	{
		return (UInt64() >> 11) * (1.0 / 9007199254740992.0);
	}

	/* generates a random number on (0,1)-real-interval */
	public double Real3()
	{
		return ((UInt64() >> 12) + 0.5) * (1.0 / 4503599627370496.0);
	}
}