...
public static class LevelSoundEventTypeSounds
{
    ...
    public class FizzSound(Vector3 position, int pitch = 0) : Sound((short) LevelSoundEventType.Fizz, position, pitch);
    ...
    public class FuseSound(Vector3 position, int pitch = 0) : Sound((short) LevelSoundEventType.Fuse, position, pitch);
    ...
    public class LaunchSound(Vector3 position, int pitch = 0) : Sound((short) LevelSoundEventType.Launch, position, pitch);
    ...
    public class CameraTakePictureSound(Vector3 position, int pitch = 0) : Sound((short) LevelSoundEventType.CameraTakePicture, position, pitch);
