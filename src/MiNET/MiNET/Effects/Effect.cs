	...
	public static List<Effect> GetEffects(short Metadata)
	{
		...
		switch (Metadata)
		{
			...
			case 37: //Turtle Master (Slowness 4 & Resistance 3, 0:20)
				effect.Add(new Slowness
				{
					Duration = 400,
					Level = 3
				});
				effect.Add(new Resistance
				{
					Duration = 400,
					Level = 2
				});
